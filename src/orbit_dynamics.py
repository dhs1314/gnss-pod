...
def total_acc_eci(pos_eci, vel_eci, mjd_tt, mjd_utc,
    ...
    # 5. Relativistic Schwarzschild correction (ECI, cheap)
    from src.relativity_orbit import compute_schwarzschild_acc
    acc_rel = compute_schwarzschild_acc(pos_eci, vel_eci)

    # 6. Empirical RTN accelerations
    total = acc_grav_eci + acc_third + acc_drag_eci + acc_srp + acc_rel
